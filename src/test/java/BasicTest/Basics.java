...
public class Basics {
	...
	public static void main(String[] args) {
		...
		String response = given().log().all().queryParam("key", "qaclick123").header("Content-Type", "application/json").body(payloadd.AddPlace())
		...
		Assert.assertEquals(actualAddress, "Pacific Ocan");
